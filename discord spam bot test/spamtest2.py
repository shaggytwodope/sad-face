...
async def send():
    ...
    # Every message ends with a random number.
    # You can get banned for sending the same message over and over.
    # So this way all the messages are slightly different
